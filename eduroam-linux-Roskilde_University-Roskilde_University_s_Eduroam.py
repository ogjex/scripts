...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Roskilde University"
Config.profilename = "Roskilde University's Eduroam"
Config.url = "http://wifi.ruc.dk"
Config.email = "servicedesk@ruc.dk"
Config.title = "eduroam CAT"
Config.server_match = "authenticate.ruc.dk"
...
Config.user_realm = "ruc.dk"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:authenticate.ruc.dk']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ruc.dk"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
